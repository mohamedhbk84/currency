...
import 'package:currency/check_internet/warning_internet_widget.dart';
import 'package:currency/data/repositories/currency_repository.dart';
import 'package:currency/core/consts/app_text_styles.dart';
import 'package:currency/currency_bloc/currency_bloc.dart';
import 'package:currency/data/models/currency_model.dart';
import 'package:currency/data/models/currency_pair.dart';
import 'package:currency/data/repositories/currency_repository.dart';
import 'package:currency/ui/pages/search_page.dart';
import 'package:currency/ui/widgets/update_button.dart';
        ...
        child: BlocBuilder<CurrencyBloc, CurrencyState>(
          ...
          builder: (context, state) {
            ...
            if (state is CurrencyLoadedState) {
              ...
              return Column(
                children: [
                  if(is_found_internet ==true)...{
                    WarningInterntWidgetCubit(onClick: () {  },),
                    _currencyPairWidget(),
                    _simpleCalculator(),
                    _bottomWidget(),
                  }else...{
                    ...
                    Container(
                        ...
                        width: MediaQuery
                            ...
                            .size
                            .width,
                        child: WarningInterntWidgetCubit(onClick: () {
